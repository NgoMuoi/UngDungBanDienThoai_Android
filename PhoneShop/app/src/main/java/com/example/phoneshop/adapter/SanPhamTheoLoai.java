...
public class SanPhamTheoLoai extends RecyclerView.Adapter<SanPhamTheoLoai.ViewHolder> {
    Context context;
    ArrayList<SanPham> sanPhams;

    public SanPhamTheoLoai(Context context, ArrayList<SanPham> sanPhams) {
        this.context = context;
        this.sanPhams = sanPhams;
    }

    @Override
    public SanPhamTheoLoai.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.layout_sanpham, parent,false);

        return new SanPhamTheoLoai.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SanPhamTheoLoai.ViewHolder holder, int position) {
