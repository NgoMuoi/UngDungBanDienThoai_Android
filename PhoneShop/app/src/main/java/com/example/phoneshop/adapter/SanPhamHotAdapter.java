...
public class SanPhamHotAdapter extends RecyclerView.Adapter<SanPhamHotAdapter.ViewHolder> {
    ...
    public SanPhamHotAdapter(Context context, ArrayList<SanPham> sanPhams) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layoutsphot, parent,false);
...
//        Picasso.get().load(sanPham.getHinhAnh()).into(holder.imageView);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            super(itemView);
            imageView = itemView.findViewById(R.id.imageViewSPHot);
            textViewTen= itemView.findViewById(R.id.textViewTenSPHot);
            textViewGia = itemView.findViewById(R.id.textViewGiaSPHot);
